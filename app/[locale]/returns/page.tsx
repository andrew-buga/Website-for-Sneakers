...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const canonical = locale === "en" ? `${siteUrl}/returns` : `${siteUrl}/${locale}/returns`
...
export default async function LocalizedReturnsPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params
